...
import type { AlphaRouterConfig } from '@intimefinance/smart-order-router'
...
function getRouter(chainId: ChainId, provider: BaseProvider): AlphaRouter {
  ...
  // TODO(zzmp): Upstream to @intimefinance/smart-order-router, exporting an enum of supported v2 chains for clarity.
  ...
  // TODO(zzmp): Upstream to @intimefinance/smart-order-router, possibly making this easier to modify
